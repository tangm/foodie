...
public class MainActivity extends Activity
    ...
    public TextView getResponse() {
        ...
        return (TextView) (fragmentView == null ? fragmentView : fragmentView.findViewById(R.id.response));
    }

    public ViewGroup getFragmentLayout() {
        final View fragmentView = fragment.getView();
        return (ViewGroup) (fragmentView == null ? fragmentView : fragmentView.findViewById(R.id.layout));
    }
